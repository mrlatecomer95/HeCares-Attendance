...
namespace DataFactory
{
    public class OLEDB
    {
        ...
        /// <returns></returns>
        public bool RunSql(string query, OleDbParameter[] sqlParam)
        {
            bool retVal = false;
            try
            {
        ...
        public bool TestConnection(string connectionString)
        {
            ...
            _connStr = new OleDbConnection(connectionString);
            try
            {
                _connStr.Open();
                _connStr.Close();
        ...
        public string DLookUp(string expr, string TableName, string DefaultValue, string Criteria)
        {
            ...
            {
                sqlConn.Open();
                using (OleDbCommand sqlcmd = new OleDbCommand())
                {
